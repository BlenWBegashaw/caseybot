...
sfdx auth:jwt:grant --clientid 3MVG9XgkMlifdwVB7aHSFpsEfvZn554iyhEGunwebN1ImlP5XMEoK7YjGcNU2Lm9ZJUylKNLhgzkoPbuy8BPh --jwtkeyfile <(echo "MIIJQQIBADANBgkqhkiG9w0BAQEFAASCCSswggknAgEAAoICAQC2v+TV2yx9DK78
...
0OV9kUaHy/EaY8/cPeMERFc/SVZi") --username $blenw@gmail.com --instanceurl https://login.salesforce.com --setdefaultdevhubusername

# Deploy the source to Salesforce
sfdx force:source:deploy -p force-app -u $blenw@gmail.com
